...
struct ServerRespCleanMode;
struct ServerRespCleanModeBuilder;

struct ServerRespStartPartition;
struct ServerRespStartPartitionBuilder;

struct ServerRespMergePartition;
struct ServerRespMergePartitionBuilder;

struct ServerRespSplitPartition;
struct ServerRespSplitPartitionBuilder;
...
enum ServerType {
  ...
  ServerType_ServerRespCleanMode = 28,
  ServerType_ServerRespStartPartition = 29,
  ServerType_ServerRespMergePartition = 30,
  ServerType_ServerRespSplitPartition = 31,
  ServerType_MIN = ServerType_NONE,
  ServerType_MAX = ServerType_ServerRespSplitPartition
};

inline const ServerType (&EnumValuesServerType())[32] {
  static const ServerType values[] = {
    ...
    ServerType_ServerRespCleanMode,
    ServerType_ServerRespStartPartition,
    ServerType_ServerRespMergePartition,
    ServerType_ServerRespSplitPartition
  };
  return values;
}
...
inline const char *EnumNameServerType(ServerType e) {
  if (flatbuffers::IsOutRange(e, ServerType_NONE, ServerType_ServerRespSplitPartition)) return "";
  const size_t index = static_cast<size_t>(e);
...
template<> struct ServerTypeTraits<abby::ServerRespCleanMode> {
  static const ServerType enum_value = ServerType_ServerRespCleanMode;
};

template<> struct ServerTypeTraits<abby::ServerRespStartPartition> {
  static const ServerType enum_value = ServerType_ServerRespStartPartition;
};

template<> struct ServerTypeTraits<abby::ServerRespMergePartition> {
  static const ServerType enum_value = ServerType_ServerRespMergePartition;
};

template<> struct ServerTypeTraits<abby::ServerRespSplitPartition> {
  static const ServerType enum_value = ServerType_ServerRespSplitPartition;
};
...
struct ServerRespCleanMode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ServerRespCleanModeBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SUCCESS = 4
  };
  bool success() const {
...
struct ServerRespCleanModeBuilder {
  typedef ServerRespCleanMode Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_success(bool success) {
    fbb_.AddElement<uint8_t>(ServerRespCleanMode::VT_SUCCESS, static_cast<uint8_t>(success), 0);
  }
  explicit ServerRespCleanModeBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ServerRespCleanModeBuilder &operator=(const ServerRespCleanModeBuilder &);
  flatbuffers::Offset<ServerRespCleanMode> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ServerRespCleanMode>(end);
    return o;
  }
};

inline flatbuffers::Offset<ServerRespCleanMode> CreateServerRespCleanMode(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool success = false) {
  ServerRespCleanModeBuilder builder_(_fbb);
  builder_.add_success(success);
  return builder_.Finish();
}

struct ServerRespStartPartition FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ServerRespStartPartitionBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SUCCESS = 4
  };
  bool success() const {
...
struct ServerRespStartPartitionBuilder {
  typedef ServerRespStartPartition Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_success(bool success) {
    fbb_.AddElement<uint8_t>(ServerRespStartPartition::VT_SUCCESS, static_cast<uint8_t>(success), 0);
  }
  explicit ServerRespStartPartitionBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ServerRespStartPartitionBuilder &operator=(const ServerRespStartPartitionBuilder &);
  flatbuffers::Offset<ServerRespStartPartition> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ServerRespStartPartition>(end);
    return o;
  }
};

inline flatbuffers::Offset<ServerRespStartPartition> CreateServerRespStartPartition(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool success = false) {
  ServerRespStartPartitionBuilder builder_(_fbb);
  builder_.add_success(success);
  return builder_.Finish();
}

struct ServerRespMergePartition FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ServerRespMergePartitionBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SUCCESS = 4
  };
  bool success() const {
...
struct ServerRespMergePartitionBuilder {
  typedef ServerRespMergePartition Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_success(bool success) {
    fbb_.AddElement<uint8_t>(ServerRespMergePartition::VT_SUCCESS, static_cast<uint8_t>(success), 0);
  }
  explicit ServerRespMergePartitionBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ServerRespMergePartitionBuilder &operator=(const ServerRespMergePartitionBuilder &);
  flatbuffers::Offset<ServerRespMergePartition> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ServerRespMergePartition>(end);
    return o;
  }
};

inline flatbuffers::Offset<ServerRespMergePartition> CreateServerRespMergePartition(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool success = false) {
  ServerRespMergePartitionBuilder builder_(_fbb);
  builder_.add_success(success);
  return builder_.Finish();
}

struct ServerRespSplitPartition FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ServerRespSplitPartitionBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SUCCESS = 4
  };
  bool success() const {
...
struct ServerRespSplitPartitionBuilder {
  typedef ServerRespSplitPartition Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_success(bool success) {
    fbb_.AddElement<uint8_t>(ServerRespSplitPartition::VT_SUCCESS, static_cast<uint8_t>(success), 0);
  }
  explicit ServerRespSplitPartitionBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ServerRespSplitPartitionBuilder &operator=(const ServerRespSplitPartitionBuilder &);
  flatbuffers::Offset<ServerRespSplitPartition> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ServerRespSplitPartition>(end);
    return o;
  }
};

inline flatbuffers::Offset<ServerRespSplitPartition> CreateServerRespSplitPartition(
    flatbuffers::FlatBufferBuilder &_fbb,
    bool success = false) {
  ServerRespSplitPartitionBuilder builder_(_fbb);
  builder_.add_success(success);
  return builder_.Finish();
}
...
struct ServerData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const abby::ServerRespCleanMode *message_as_ServerRespCleanMode() const {
    return message_type() == abby::ServerType_ServerRespCleanMode ? static_cast<const abby::ServerRespCleanMode *>(message()) : nullptr;
  }
  const abby::ServerRespStartPartition *message_as_ServerRespStartPartition() const {
    return message_type() == abby::ServerType_ServerRespStartPartition ? static_cast<const abby::ServerRespStartPartition *>(message()) : nullptr;
  }
  const abby::ServerRespMergePartition *message_as_ServerRespMergePartition() const {
    return message_type() == abby::ServerType_ServerRespMergePartition ? static_cast<const abby::ServerRespMergePartition *>(message()) : nullptr;
  }
  const abby::ServerRespSplitPartition *message_as_ServerRespSplitPartition() const {
    return message_type() == abby::ServerType_ServerRespSplitPartition ? static_cast<const abby::ServerRespSplitPartition *>(message()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const abby::ServerRespCleanMode *ServerData::message_as<abby::ServerRespCleanMode>() const {
  return message_as_ServerRespCleanMode();
}

template<> inline const abby::ServerRespStartPartition *ServerData::message_as<abby::ServerRespStartPartition>() const {
  return message_as_ServerRespStartPartition();
}

template<> inline const abby::ServerRespMergePartition *ServerData::message_as<abby::ServerRespMergePartition>() const {
  return message_as_ServerRespMergePartition();
}

template<> inline const abby::ServerRespSplitPartition *ServerData::message_as<abby::ServerRespSplitPartition>() const {
  return message_as_ServerRespSplitPartition();
}
...
inline bool VerifyServerType(flatbuffers::Verifier &verifier, const void *obj, ServerType type) {
  switch (type) {
    ...
    case ServerType_ServerRespCleanMode: {
      auto ptr = reinterpret_cast<const abby::ServerRespCleanMode *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ServerType_ServerRespStartPartition: {
      auto ptr = reinterpret_cast<const abby::ServerRespStartPartition *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ServerType_ServerRespMergePartition: {
      auto ptr = reinterpret_cast<const abby::ServerRespMergePartition *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ServerType_ServerRespSplitPartition: {
      auto ptr = reinterpret_cast<const abby::ServerRespSplitPartition *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }

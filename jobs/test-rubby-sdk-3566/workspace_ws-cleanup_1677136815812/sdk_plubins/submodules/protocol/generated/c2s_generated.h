...
struct ClientReqStartPartition;
struct ClientReqStartPartitionBuilder;

struct ClientReqMergePartition;
struct ClientReqMergePartitionBuilder;

struct ClientReqSplitPartition;
struct ClientReqSplitPartitionBuilder;
...
enum ClientType {
  ...
  ClientType_ClientReqStartPartition = 22,
  ClientType_ClientReqMergePartition = 23,
  ClientType_ClientReqSplitPartition = 24,
  ClientType_MIN = ClientType_NONE,
  ClientType_MAX = ClientType_ClientReqSplitPartition
};

inline const ClientType (&EnumValuesClientType())[25] {
  static const ClientType values[] = {
    ...
    ClientType_ClientReqStartPartition,
    ClientType_ClientReqMergePartition,
    ClientType_ClientReqSplitPartition
  };
  return values;
}
...
inline const char *EnumNameClientType(ClientType e) {
  if (flatbuffers::IsOutRange(e, ClientType_NONE, ClientType_ClientReqSplitPartition)) return "";
  const size_t index = static_cast<size_t>(e);
...
template<> struct ClientTypeTraits<abby::ClientReqStartPartition> {
  static const ClientType enum_value = ClientType_ClientReqStartPartition;
};

template<> struct ClientTypeTraits<abby::ClientReqMergePartition> {
  static const ClientType enum_value = ClientType_ClientReqMergePartition;
};

template<> struct ClientTypeTraits<abby::ClientReqSplitPartition> {
  static const ClientType enum_value = ClientType_ClientReqSplitPartition;
};
...
struct ClientReqStartPartition FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ClientReqStartPartitionBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SCENE_ID = 4,
    VT_MAP_ID = 6,
    VT_OBJECT_IDS = 8,
  ...
  const flatbuffers::Vector<int32_t> *object_ids() const {
    return GetPointer<const flatbuffers::Vector<int32_t> *>(VT_OBJECT_IDS);
  }
  const flatbuffers::Vector<flatbuffers::Offset<abby::Area>> *areas() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<abby::Area>> *>(VT_AREAS);
  }
...
struct ClientReqStartPartitionBuilder {
  typedef ClientReqStartPartition Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_scene_id(int64_t scene_id) {
    fbb_.AddElement<int64_t>(ClientReqStartPartition::VT_SCENE_ID, scene_id, 0);
  }
  void add_map_id(int64_t map_id) {
    fbb_.AddElement<int64_t>(ClientReqStartPartition::VT_MAP_ID, map_id, 0);
  }
  void add_object_ids(flatbuffers::Offset<flatbuffers::Vector<int32_t>> object_ids) {
    fbb_.AddOffset(ClientReqStartPartition::VT_OBJECT_IDS, object_ids);
  }
  void add_areas(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<abby::Area>>> areas) {
    fbb_.AddOffset(ClientReqStartPartition::VT_AREAS, areas);
  }
  explicit ClientReqStartPartitionBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ClientReqStartPartitionBuilder &operator=(const ClientReqStartPartitionBuilder &);
  flatbuffers::Offset<ClientReqStartPartition> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ClientReqStartPartition>(end);
    return o;
  }
};

inline flatbuffers::Offset<ClientReqStartPartition> CreateClientReqStartPartition(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t scene_id = 0,
    int64_t map_id = 0,
    flatbuffers::Offset<flatbuffers::Vector<int32_t>> object_ids = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<abby::Area>>> areas = 0) {
  ClientReqStartPartitionBuilder builder_(_fbb);
  builder_.add_map_id(map_id);
  builder_.add_scene_id(scene_id);
  builder_.add_areas(areas);
...
inline flatbuffers::Offset<ClientReqStartPartition> CreateClientReqStartPartitionDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t scene_id = 0,
    int64_t map_id = 0,
    const std::vector<int32_t> *object_ids = nullptr,
    const std::vector<flatbuffers::Offset<abby::Area>> *areas = nullptr) {
  auto object_ids__ = object_ids ? _fbb.CreateVector<int32_t>(*object_ids) : 0;
  auto areas__ = areas ? _fbb.CreateVector<flatbuffers::Offset<abby::Area>>(*areas) : 0;
  return abby::CreateClientReqStartPartition(
      _fbb,
      scene_id,
      map_id,
      object_ids__,
...
struct ClientReqMergePartition FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ClientReqMergePartitionBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SCENE_ID = 4,
    VT_MAP_ID = 6,
    VT_OBJECT_IDS = 8,
...
struct ClientReqMergePartitionBuilder {
  typedef ClientReqMergePartition Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_scene_id(int64_t scene_id) {
    fbb_.AddElement<int64_t>(ClientReqMergePartition::VT_SCENE_ID, scene_id, 0);
  }
  void add_map_id(int64_t map_id) {
    fbb_.AddElement<int64_t>(ClientReqMergePartition::VT_MAP_ID, map_id, 0);
  }
  void add_object_ids(flatbuffers::Offset<flatbuffers::Vector<int32_t>> object_ids) {
    fbb_.AddOffset(ClientReqMergePartition::VT_OBJECT_IDS, object_ids);
  }
  void add_areas(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<abby::Area>>> areas) {
    fbb_.AddOffset(ClientReqMergePartition::VT_AREAS, areas);
  }
  explicit ClientReqMergePartitionBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ClientReqMergePartitionBuilder &operator=(const ClientReqMergePartitionBuilder &);
  flatbuffers::Offset<ClientReqMergePartition> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ClientReqMergePartition>(end);
    return o;
  }
};

inline flatbuffers::Offset<ClientReqMergePartition> CreateClientReqMergePartition(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t scene_id = 0,
    int64_t map_id = 0,
    flatbuffers::Offset<flatbuffers::Vector<int32_t>> object_ids = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<abby::Area>>> areas = 0) {
  ClientReqMergePartitionBuilder builder_(_fbb);
  builder_.add_map_id(map_id);
  builder_.add_scene_id(scene_id);
  builder_.add_areas(areas);
  builder_.add_object_ids(object_ids);
...
inline flatbuffers::Offset<ClientReqMergePartition> CreateClientReqMergePartitionDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t scene_id = 0,
    int64_t map_id = 0,
    const std::vector<int32_t> *object_ids = nullptr,
  ...
  auto object_ids__ = object_ids ? _fbb.CreateVector<int32_t>(*object_ids) : 0;
  auto areas__ = areas ? _fbb.CreateVector<flatbuffers::Offset<abby::Area>>(*areas) : 0;
  return abby::CreateClientReqMergePartition(
      _fbb,
      scene_id,
      map_id,
      object_ids__,
...
struct ClientReqSplitPartition FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ClientReqSplitPartitionBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_SCENE_ID = 4,
    VT_MAP_ID = 6,
    VT_OBJECT_IDS = 8,
  ...
  int32_t object_ids() const {
    return GetField<int32_t>(VT_OBJECT_IDS, 0);
  }
  const abby::Area *areas() const {
    return GetPointer<const abby::Area *>(VT_AREAS);
  }
  const abby::Point2D *p1() const {
    return GetPointer<const abby::Point2D *>(VT_P1);
  }
  const abby::Point2D *p2() const {
    return GetPointer<const abby::Point2D *>(VT_P2);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int64_t>(verifier, VT_SCENE_ID) &&
           VerifyField<int64_t>(verifier, VT_MAP_ID) &&
           VerifyField<int32_t>(verifier, VT_OBJECT_IDS) &&
           VerifyOffset(verifier, VT_AREAS) &&
           verifier.VerifyTable(areas()) &&
           VerifyOffset(verifier, VT_P1) &&
           verifier.VerifyTable(p1()) &&
           VerifyOffset(verifier, VT_P2) &&
           verifier.VerifyTable(p2()) &&
           verifier.EndTable();
  }
};

struct ClientReqSplitPartitionBuilder {
  typedef ClientReqSplitPartition Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_scene_id(int64_t scene_id) {
    fbb_.AddElement<int64_t>(ClientReqSplitPartition::VT_SCENE_ID, scene_id, 0);
  }
  void add_map_id(int64_t map_id) {
    fbb_.AddElement<int64_t>(ClientReqSplitPartition::VT_MAP_ID, map_id, 0);
  }
  void add_object_ids(int32_t object_ids) {
    fbb_.AddElement<int32_t>(ClientReqSplitPartition::VT_OBJECT_IDS, object_ids, 0);
  }
  void add_areas(flatbuffers::Offset<abby::Area> areas) {
    fbb_.AddOffset(ClientReqSplitPartition::VT_AREAS, areas);
  }
  void add_p1(flatbuffers::Offset<abby::Point2D> p1) {
    fbb_.AddOffset(ClientReqSplitPartition::VT_P1, p1);
  }
  void add_p2(flatbuffers::Offset<abby::Point2D> p2) {
    fbb_.AddOffset(ClientReqSplitPartition::VT_P2, p2);
  }
  explicit ClientReqSplitPartitionBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ClientReqSplitPartitionBuilder &operator=(const ClientReqSplitPartitionBuilder &);
  flatbuffers::Offset<ClientReqSplitPartition> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<ClientReqSplitPartition>(end);
    return o;
  }
};

inline flatbuffers::Offset<ClientReqSplitPartition> CreateClientReqSplitPartition(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t scene_id = 0,
    int64_t map_id = 0,
    int32_t object_ids = 0,
    flatbuffers::Offset<abby::Area> areas = 0,
    flatbuffers::Offset<abby::Point2D> p1 = 0,
    flatbuffers::Offset<abby::Point2D> p2 = 0) {
  ClientReqSplitPartitionBuilder builder_(_fbb);
  builder_.add_map_id(map_id);
  builder_.add_scene_id(scene_id);
  builder_.add_p2(p2);
  builder_.add_p1(p1);
...
struct ClientData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const abby::ClientReqStartPartition *message_as_ClientReqStartPartition() const {
    return message_type() == abby::ClientType_ClientReqStartPartition ? static_cast<const abby::ClientReqStartPartition *>(message()) : nullptr;
  }
  const abby::ClientReqMergePartition *message_as_ClientReqMergePartition() const {
    return message_type() == abby::ClientType_ClientReqMergePartition ? static_cast<const abby::ClientReqMergePartition *>(message()) : nullptr;
  }
  const abby::ClientReqSplitPartition *message_as_ClientReqSplitPartition() const {
    return message_type() == abby::ClientType_ClientReqSplitPartition ? static_cast<const abby::ClientReqSplitPartition *>(message()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const abby::ClientReqStartPartition *ClientData::message_as<abby::ClientReqStartPartition>() const {
  return message_as_ClientReqStartPartition();
}

template<> inline const abby::ClientReqMergePartition *ClientData::message_as<abby::ClientReqMergePartition>() const {
  return message_as_ClientReqMergePartition();
}

template<> inline const abby::ClientReqSplitPartition *ClientData::message_as<abby::ClientReqSplitPartition>() const {
  return message_as_ClientReqSplitPartition();
}
...
inline bool VerifyClientType(flatbuffers::Verifier &verifier, const void *obj, ClientType type) {
  switch (type) {
    ...
    case ClientType_ClientReqStartPartition: {
      auto ptr = reinterpret_cast<const abby::ClientReqStartPartition *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ClientType_ClientReqMergePartition: {
      auto ptr = reinterpret_cast<const abby::ClientReqMergePartition *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case ClientType_ClientReqSplitPartition: {
      auto ptr = reinterpret_cast<const abby::ClientReqSplitPartition *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }

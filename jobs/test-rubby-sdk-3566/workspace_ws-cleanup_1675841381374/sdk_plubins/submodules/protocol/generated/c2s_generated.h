...
enum ClientType {
  ...
  ClientType_MAX = ClientType_ClientReqListTimer
};

inline const ClientType (&EnumValuesClientType())[21] {
...
inline const char *EnumNameClientType(ClientType e) {
  if (flatbuffers::IsOutRange(e, ClientType_NONE, ClientType_ClientReqListTimer)) return "";
  const size_t index = static_cast<size_t>(e);

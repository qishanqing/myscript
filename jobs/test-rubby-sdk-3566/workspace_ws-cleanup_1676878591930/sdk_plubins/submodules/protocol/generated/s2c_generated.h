...
enum ServerType {
  ...
  ServerType_MAX = ServerType_ServerRespCleanMode
};

inline const ServerType (&EnumValuesServerType())[29] {
...
inline const char *EnumNameServerType(ServerType e) {
  if (flatbuffers::IsOutRange(e, ServerType_NONE, ServerType_ServerRespCleanMode)) return "";
  const size_t index = static_cast<size_t>(e);

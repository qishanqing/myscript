...
//
#include "model_npu.h"
#include "src/module/npu/vnn/vnn_yolov3.h"
#include "src/module/npu/vnn/vnn_yolov3_tiny.h"
#include "src/utils/utils.h"
#include "src/utils/file.h"
#include "src/utils/define.h"

const vsi_nn_postprocess_map_element_t *ModelNPU::postprocessMap = nullptr;
const vsi_nn_preprocess_map_element_t *ModelNPU::preprocessMap = nullptr;
...
bool ModelNPU::CreateNetwork(const std::string modelFile)
{
...
bool ModelNPU::UploadTensor(void *input)
{
...
bool ModelNPU::DownloadTensor(float **output)
{
...
const vsi_nn_preprocess_map_element_t *ModelNPU::GetPrePorcessMap()
{
    return preprocessMap;
}

uint32_t ModelNPU::vnn_GetPrePorcessMapCount()
{
...
const vsi_nn_postprocess_map_element_t *ModelNPU::GetPostPorcessMap()
{
    return postprocessMap;
}

uint32_t ModelNPU::vnn_GetPostPorcessMapCount()
{
...
void ModelNPU::GetOutputSize(std::vector<unsigned long> &outputSize) const
{
}
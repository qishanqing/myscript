              ...
              , cv::Mat& remapX, cv::Mat& remapY)
{
    ...
    // R_l = cv::Mat(3, 3, CV_64FC1, (unsigned char *) cameraParam._R);
...
//    cv::Mat rgb(image.cols, image.cols, CV_8UC3);
//
//    for(int h = 0 ; h < image.rows ; ++ h)
//    {
//        for(int w = 0 ; w < image.cols / 2 ; ++ w)
//        {
//            rgb.at<cv::Vec3b>(h , w)[0] = remap.at<char>(h, w);
//            rgb.at<cv::Vec3b>(h , w)[1] = remap.at<char>(h, w);
//            rgb.at<cv::Vec3b>(h , w)[2] = remap.at<char>(h, w);
//        }
//    }

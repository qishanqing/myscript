...
vsi_nn_graph_t *vnn_CreateYolov3Tiny
        (
        ...
        )
{
    ...
    const int OUTPUT_CHANNEL = (classNum + 5) * 3;
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.size[0] = 13;
    attr.size[1] = 13;
    attr.size[2] = OUTPUT_CHANNEL;
    attr.size[3] = 1;
    attr.dim_num = 4;
    attr.dtype.fl = TYPE[0];
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_DFP;
...
void vnn_ReleaseYolov3
        (
                vsi_nn_graph_t *graph, vsi_bool release_ctx
        )
{
    vsi_nn_context_t ctx;
    if (NULL != graph)

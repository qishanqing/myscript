...
void PrintObject(const std::vector<BoxInfo> &boxes, const bool senmatic = false);
...
void Machine2World(const psl::Location &pm, psl::Location &pw, const psl::SlamResult &pose);

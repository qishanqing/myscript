...
protected:
	...
	void mergeRooms(cv::Mat& map_to_merge_rooms, std::vector<Room>& rooms, double map_resolution_from_subscription, double max_area_for_merging, bool display_map,MapSegmentationGoal &goal,std::vector<std::vector<cv::Point>> &room_contours);

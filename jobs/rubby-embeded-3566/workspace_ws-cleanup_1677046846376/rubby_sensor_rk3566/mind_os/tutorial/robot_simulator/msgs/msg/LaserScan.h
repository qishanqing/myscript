...
namespace mind_os {
template<>
inline void serialize(const tutorial::sensor::LaserScan& data, BytesBuffer& buffer) {
    ...
    serialize(data.ranges, buffer);
    serialize(data.intensities, buffer);
}; /* serialization of tutorial::sensor::LaserScan */

template<>
inline void deserialize(BytesBuffer& buffer, tutorial::sensor::LaserScan& data) {
    ...
    deserialize(buffer, data.ranges);
    deserialize(buffer, data.intensities);

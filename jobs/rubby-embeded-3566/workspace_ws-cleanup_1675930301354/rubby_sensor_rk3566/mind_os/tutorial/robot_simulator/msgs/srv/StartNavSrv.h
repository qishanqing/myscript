...
namespace mind_os {
template<>
void serialize(const tutorial::nav::StartNavSrv::Request& data, BytesBuffer& buffer) {
    serialize(data.mode, buffer);
}; /* serialization of tutorial::nav::StartNavSrv Request */

template<>
void serialize(const tutorial::nav::StartNavSrv::Response& data, BytesBuffer& buffer) {
    serialize(data.success, buffer);
}; /* serialization of tutorial::nav::StartNavSrv Response */

template<>
void deserialize(BytesBuffer& buffer, tutorial::nav::StartNavSrv::Request& data) {
    deserialize(buffer, data.mode);
}; /* de-serialization of tutorial::nav::StartNavSrv Request */
template<>
void deserialize(BytesBuffer& buffer, tutorial::nav::StartNavSrv::Response& data) {

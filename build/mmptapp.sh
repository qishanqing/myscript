...
init_project_env(){
    ...
    appname=MMPT
    sourcename=midea_module_production_tool
    ...
    CLONE_DEPTH="--depth=1"
    CONFIG_REMOTE="git clone ssh://git@192.168.50.191:222/AroundI18RProject/i18rconfig $CONFIG_DIR -b midea_module_production_tool  $CLONE_DEPTH"

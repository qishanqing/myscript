...
init_project_env(){
    ...
    UI_DIR=/mnt/ftp/release/$/client
    TEST_DIR=/mnt/ftp/release/${upload_ftp_project}/test
    FTP_RELEASE_DIR=/mnt/ftp/release/${upload_ftp_project}/fresh_version
...
#    Add_Tag
	...
	cmdb_mysql "update indemindapp set status='2', deb_md5ck='$deb_md5' where build_url='$BUILD_URL';"

...
apt update
apt install unzip expect ftp openjdk-11-jdk lftp curl  curlftpfs rsync mysql-client ntpdate stow libucl-dev libglew-dev glew-utils qtbase5-private-dev cppcheck -y
